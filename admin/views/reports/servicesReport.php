...
class PDF extends FPDF
{
    function LoadData()
    {
        ...
        foreach ($servicio->Listar() as $r) {
            $data[] = array($r->service_id, $r->description, $r->price);
        }
        //print_r($data);
        return $data;
    }
    function header()
    {
        ...
        $this->Cell(260, 50, 'Registro de servicios', 0, 0, 'C');
        $this->Ln();
...
$pdf->AliasNbPages();
$pdf->AddPage('L', 'A4', 0);
$header  = array('Id', 'Descripcion', 'Precio');
$data = $pdf->LoadData();
